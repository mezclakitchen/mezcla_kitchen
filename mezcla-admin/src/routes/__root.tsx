...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Mezcla Admin — The Artisanal Kitchen" },
      { name: "description", content: "Premium admin dashboard for Mezcla — orders, billing, products, customers and WhatsApp marketing." },
    ],
    links: [
