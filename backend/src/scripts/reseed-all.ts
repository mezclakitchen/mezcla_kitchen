  ...
  const sourdoughProducts = [
    {
      ...
      variants: [
        { name: 'Maida', price: 200, price_label: '₹200' },
        { name: 'Whole Wheat', price: 200, price_label: '₹200' }
      ]
    },
    {
  ...
  const dipsProducts = [
    {
      ...
      slug: 'classic-hummus',
      description:
        'Our classic Middle Eastern dip made with chickpeas, tahini, extra virgin olive oil, fresh lemon and garlic. Silky smooth, wholesome and full of flavour — perfect with warm pita, sourdough or fresh vegetables.',
      price: 225,
      price_label: '₹225',
      is_available: true,
      is_featured: true,
